      ...
      {showSidebar && (
        <>
          <div className="p-4 border-b border-gray-200">
            <h2 className="text-lg font-bold text-gray-900">项目知识库</h2>
            <p className="text-sm text-gray-600 mt-1">选择项目以获取相关背景信息</p>
          </div>
          ...
          <div className="overflow-y-auto flex-1">
            ...
            <ul className="divide-y divide-gray-200">
              {filteredProjects.map(project => (
                <li 
                  key={project.id}
                  className={`px-4 py-3 hover:bg-gray-50 cursor-pointer ${selectedProject?.id === project.id ? 'bg-blue-50' : ''}`}
